...
export default function DoctorDashboard() {
  ...
  const fetchTodayAppointments = async () => {
    try {
      ...
      const response = await api.get(`/citas/medico?fecha=${today}`);
  ...
  return (
    <div>
      ...
      <p style={styles.subtitle}>Panel del medico - {dayjs().format('dddd DD/MM/YYYY')}</p>

      <div style={styles.actions}>
        <Link to="/medico/agenda" style={styles.actionCard}>
          <span style={styles.actionIcon}>📅</span>
          <span>Mi Agenda</span>
        </Link>
        <Link to="/medico/atender" style={styles.actionCard}>
          <span style={styles.actionIcon}>🩺</span>
      ...
      {loading ? (
        ...
        <p style={styles.empty}>No tiene citas programadas para hoy.</p>
      ) : (
            ...
            <div key={cita.id} style={styles.card}>
              <div style={styles.cardHeader}>
                <div>
                  ...
                  <span style={styles.time}> - {cita.hora_inicio}</span>
                </div>
                <span
                  style={{
                    ...styles.badge,
